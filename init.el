...
(custom-set-variables
 ...
 '(package-selected-packages
   '(flycheck-languagetool use-package ws-butler kill-file-path yaml-mode zenburn-theme flycheck magit markdown-mode robot-mode ace-window yasnippet-snippets yasnippet company chyla-theme diff-hl)))
(custom-set-faces
