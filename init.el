...
(custom-set-variables
 ...
 '(package-selected-packages
   '(kill-file-path yaml-mode ethan-wspace spacemacs-theme zenburn-theme flycheck magit markdown-mode robot-mode ace-window yasnippet-snippets yasnippet company chyla-theme diff-hl)))
(custom-set-faces
