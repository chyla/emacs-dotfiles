...
(custom-set-variables
 ...
 '(package-selected-packages
   '(chyla-dark-theme flycheck-languagetool use-package ws-butler kill-file-path yaml-mode zenburn-theme flycheck magit markdown-mode robot-mode ace-window yasnippet company chyla-theme diff-hl)))
(custom-set-faces
